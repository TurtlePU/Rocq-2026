...
Makefile.conf: _CoqProject
	rocq makefile -f _CoqProject BasicsTest.v Basics.v InductionTest.v Induction.v ListsTest.v Lists.v LogicTest.v Logic.v PolyTest.v Poly.v TacticsTest.v Tactics.v -o Makefile
